...
class PPR_ins_inter_dataset(data.Dataset):
    def __init__(self, opt):
        super(PPR_ins_inter_dataset, self).__init__()
        self.opt = opt
        ...
        self.paths_MASK = util.get_MASK_paths(self.paths_GT, opt['json'], opt['inst_path'], opt['dataroot_MASK'])
