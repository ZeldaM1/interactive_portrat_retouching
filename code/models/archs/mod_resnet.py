...
def resnet18(pretrained=True, extra_chan=0):
    ...
    if pretrained:
        # load_weights_sequential(model, torch.load('./resnet18.pth', map_location=None), extra_chan)
...
def vgg16(pretrained=True, extra_chan=0):
    model = models.vgg16()
    if pretrained:
        load_weights_sequential(model, torch.load('./vgg16-397923af.pth', map_location=None), extra_chan)
